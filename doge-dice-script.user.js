      ...
      // wish sync mode worked :(
       this.connect = function ( type, myCurr, second ) {
        ...
        this.writePrice = function ( priceData ) { 
            ...
            $('.chatinput').val( doge+" DOGE is currently worth "+total.toFixed(8)+" BTC ($"+(parseFloat(total)*parseFloat(priceData['btc']))+") on "+priceData['market']+" (1 DOGE = "+priceData['doge']+" BTC)" );
        }
}
